...
.icon-grid-wrap { min-height: 240px; }.icon-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(112px, 1fr)); border-top: 1px solid var(--cp-border); border-left: 1px solid var(--cp-border); }.icon-grid__item { display: flex; min-width: 0; min-height: 88px; align-items: center; justify-content: center; flex-direction: column; gap: $spacing-sm; padding: $spacing-sm; border: 0; border-right: 1px solid var(--cp-border); border-bottom: 1px solid var(--cp-border); color: var(--cp-text-secondary); background: transparent; cursor: pointer; transition: color $transition-fast, background $transition-fast; }.icon-grid__item:hover, .icon-grid__item:focus-visible, .icon-grid__item.is-selected { outline: 0; color: var(--cp-primary); background: var(--cp-primary-lighter); }.icon-grid__item span { width: 100%; overflow: hidden; font-size: $font-xs; text-align: center; text-overflow: ellipsis; white-space: nowrap; }.icon-grid-pagination { --el-pagination-bg-color: var(--cp-bg-hover); --el-pagination-button-bg-color: var(--cp-bg-hover); --el-pagination-button-color: var(--cp-text); --el-pagination-hover-color: var(--cp-primary); justify-content: center; padding: $spacing-md; }.icon-grid-pagination :deep(.el-pager li) { color: var(--cp-text); background-color: var(--cp-bg-hover); }.icon-grid-pagination :deep(.el-pager li.is-active) { color: var(--cp-primary-contrast); background-color: var(--cp-primary); }.icon-grid-pagination :deep(.btn-prev), .icon-grid-pagination :deep(.btn-next) { color: var(--cp-text); background-color: var(--cp-bg-hover); }
