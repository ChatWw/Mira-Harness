...
.global-header { width: 100%; min-height: 52px; display: flex; align-items: center; gap: $spacing-md; padding: 0 24px; background: var(--cp-bg); border-bottom: 1px solid var(--cp-layout-border); flex-shrink: 0; z-index: $z-sticky; }
...
.rail-brand { color: #fff; background: linear-gradient(135deg, var(--cp-primary), color-mix(in srgb, var(--cp-primary) 55%, #635bff)); box-shadow: 0 5px 12px color-mix(in srgb, var(--cp-primary) 25%, transparent); .brand-logo { width: 20px; height: 20px; } }
...
.global-brand { min-width: 0; display: flex; align-items: center; gap: 9px; flex: 1; font-size: 16px; font-weight: 650; color: var(--cp-text); white-space: nowrap; overflow: hidden; }
.brand-mark { width: 31px; height: 31px; display: grid; place-items: center; color: #fff; border-radius: 9px; background: linear-gradient(135deg, var(--cp-primary), color-mix(in srgb, var(--cp-primary) 55%, #635bff)); box-shadow: 0 5px 12px color-mix(in srgb, var(--cp-primary) 25%, transparent); .brand-logo { width: 19px; height: 19px; } }
...
.collapse-btn { font-size: $font-xl; flex-shrink: 0; }.global-breadcrumb { min-width: 0; overflow: hidden; }.global-actions { display: flex; align-items: center; gap: $spacing-md; margin-left: auto; flex-shrink: 0; }.global-toolbar { display: flex; align-items: center; gap: 2px; :deep(.el-button) { width: 32px; height: 32px; padding: 0; margin: 0; } :deep(.el-button + .el-button) { margin-left: 0; } :deep(.notification-trigger) { width: 32px; height: 32px; } }
