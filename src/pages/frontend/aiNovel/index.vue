      ...
      <div class="novel-home__content">
        ...
        <div class="novel-home__status">
          ...
          <template v-else>
            ...
            <Transition name="novel-actions" appear>
              <div class="novel-home__ready-actions">
...
.novel-home__status { display: flex; min-height: 144px; align-items: center; flex-direction: column; justify-content: flex-start; }.novel-home--loading .novel-home__status { min-height: 144px; }
.novel-progress span { animation: none; transition: width 80ms linear; }
.novel-actions-enter-active { transition: opacity 280ms ease-out, transform 280ms ease-out; }.novel-actions-enter-from { opacity: 0; transform: translateY(10px); }.novel-home__ready-actions { width: 100%; }.novel-actions-enter-active .novel-hotkey { transition: opacity 180ms ease-out 100ms; }.novel-actions-enter-from .novel-hotkey { opacity: 0; } @media (prefers-reduced-motion: reduce) { .novel-actions-enter-active, .novel-actions-enter-active .novel-hotkey { transition: none; } }
</style>
