...
contextBridge.exposeInMainWorld('platform', {
  ...
  listHarnessMemories: (projectId?: string) => ipcRenderer.invoke('harness:list-memories', projectId),
  saveHarnessMemory: (memory: unknown) => ipcRenderer.invoke('harness:save-memory', memory),
  deleteHarnessMemory: (id: string) => ipcRenderer.invoke('harness:delete-memory', id),
  clearHarnessProjectMemories: (projectId: string) => ipcRenderer.invoke('harness:clear-project-memories', projectId),
  getHarnessMemoryAutoEnabled: () => ipcRenderer.invoke('harness:get-memory-auto-enabled'),
  setHarnessMemoryAutoEnabled: (enabled: boolean) => ipcRenderer.invoke('harness:set-memory-auto-enabled', enabled),
