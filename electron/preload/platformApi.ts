...
export const platformApi = {
  ...
  generateFirstPartyText: (appId: string, role: 'authoring' | 'automation', prompt: string, selection: unknown) => ipcRenderer.invoke('platform:generate-first-party-text', appId, role, prompt, selection),
